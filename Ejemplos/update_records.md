...
Este capítulo proporciona un ejemplo sobre cómo actualizar registros en una tabla usando la aplicación JDBC. Antes de ejecutar el siguiente ejemplo, asegúrese de tener lo siguiente en su lugar:
...
- **Ejecutar una consulta**: requiere el uso de un objeto de tipo Instrucción para crear y enviar una instrucción SQL para actualizar los registros en una tabla. Esta consulta hace uso de la cláusula IN y WHERE para actualizar registros condicionales.
