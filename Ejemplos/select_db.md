...
Este capítulo proporciona un ejemplo sobre cómo seleccionar una base de datos utilizando la aplicación JDBC. Antes de ejecutar el siguiente ejemplo, asegúrese de tener lo siguiente en su lugar:
...
- **Abrir una conexión**: requiere usar el método `DriverManager.getConnection()` para crear un objeto Connection, que representa una conexión física con una base de datos seleccionada.  
  La selección de la base de datos se realiza mientras prepara la URL de la base de datos. El siguiente ejemplo haría conexión con la base de datos de ESTUDIANTES.
