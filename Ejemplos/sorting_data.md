...
Este capítulo proporciona un ejemplo sobre cómo ordenar registros de una tabla usando la aplicación JDBC. Esto usaría palabras clave asc y desc para ordenar registros en orden ascendente o descendente. Antes de ejecutar el siguiente ejemplo, asegúrese de tener lo siguiente en su lugar:
...
- **Ejecutar una consulta**: requiere el uso de un objeto de tipo Declaración para crear y enviar una declaración SQL para ordenar los registros de una tabla. Estas consultas utilizan cláusulas asc y desc para clasificar los datos en orden ascendente y descendente.
