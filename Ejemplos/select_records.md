...
Este capítulo proporciona un ejemplo sobre cómo seleccionar / recuperar registros de una tabla utilizando la aplicación JDBC. Antes de ejecutar el siguiente ejemplo, asegúrese de tener lo siguiente en su lugar:
...
- **Ejecutar una consulta**: requiere el uso de un objeto de tipo Declaración para crear y enviar una declaración SQL para seleccionar (es decir, recuperar) registros de una tabla.

- **Extraer datos**: una vez que se ejecuta la consulta SQL, puede obtener registros de la tabla.
